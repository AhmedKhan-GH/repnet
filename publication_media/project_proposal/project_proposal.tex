...
\title{Risk Estimating Preeclampsia Project Proposal}
...
\resizebox{\textwidth}{!}{%
\begin{tabular}{c}
\url{https://github.com/AhmedKhan-GH/repnet}\\[0.2em]
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.48\linewidth]{557737215_122141418656891576_230113301145304171_n}\hfill
  \includegraphics[width=0.48\linewidth]{c851b6_fcc62bdd5da74d328afd9dd27e40b2f0-1}
...
Block 1: $k=9, f=64$, output $2500 \times 64$;
Block 2: $k=9, f=80$, output $1250 \times 80$;
Block 3: $k=5, f=128$, output $625 \times 128$;
Block 4: $k=13, f=48$, output $312 \times 48$;
Block 5: $k=3, f=80$, output $156 \times 80$;
Block 6: $k=5, f=64$, output $78 \times 64$;
Block 7: $k=13, f=112$, output $39 \times 112$;
Block 8: $k=9, f=48$, output $19 \times 48$;
Block 9: $k=7, f=80$, output $9 \times 80$;
Block 10: $k=11, f=16$, output $4 \times 16$;
Block 11: $k=13, f=16$, output $2 \times 16$.
