...
\begin{column}{\colwidth}
  ...
  \begin{block}{RepNet-RF: Decision-Tree Results}
    ...
    \begin{figure}
      \centering
      \includegraphics[width=0.95\colwidth]{leadimportance.png}
    \end{figure}
  \end{block}
