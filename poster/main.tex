...
\logoleft{%
  \makebox[0pt][l]{%
    \ensuremath{\vcenter{\hbox{\includegraphics[height=9cm]{logo.png}}}}% Left RUbiNet Logo
    \hspace*{5.8cm}% Fine-tuned spacing to position the QR code exactly in the middle of the gap
    \ensuremath{\vcenter{\hbox{\includegraphics[height=8.0cm]{qrcode.png}}}}% Correct size-profile QR code
  }%
}
...
\logoright{%
  ...
  \begin{tabular*}{\colwidth}{@{\extracolsep{\fill}} c c c}
    & \ensuremath{\vcenter{\hbox{\includegraphics[height=5.5cm]{ece_header_white_text.png}}}} & \ensuremath{\vcenter{\hbox{\color{white}\fontsize{80}{80}\selectfont\bfseries 117}}}
  \end{tabular*}%
}
...
\begin{column}{\colwidth}
  ...
  \begin{block}{RepNet-SE: Model Interpretability}
    ...
    Combined Integrated-Gradients and Grad-CAM saliency on Lead II concentrates on the QRS complexes and ST segments. True positives attribute toward PE (red) at these landmarks --- consistent with the cardiac effects of preeclampsia --- while true negatives attribute toward Normal (blue) at the same complexes.
  \end{block}
