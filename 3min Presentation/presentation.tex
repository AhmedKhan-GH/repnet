...
\begin{frame}{Conclusion \& Future Work}
  ...
  \begin{beamercolorbox}[wd=\textwidth,rounded=true,shadow=false,sep=0.3em]{boxgray}
    ...
    \resizebox{\textwidth}{!}{%
      \begin{tabular}{lcccccc}
        ...
        Neural Network     & $70.9 \pm 4.9$   & $34.2 \pm 7.5$   & $73.0 \pm 9.2$   & $62.7 \pm 12.6$   & $0.00 \pm 0.00$   & $40.4 \pm 6.9$ \\
      \end{tabular}%
    }
  \end{beamercolorbox}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.45\textwidth}
      \raggedright
      {\large\Raleway\bfseries\color{black} Data \& Validation}\\[0.4em]
      \begin{itemize}
        \setlength{\itemsep}{0.3em}
        \footnotesize % Increased from \tiny to \footnotesize
      ...
      {\large\Raleway\bfseries\color{black} Modeling \& Deployment}\\[0.4em]
      \begin{itemize}
        \setlength{\itemsep}{0.3em}
        \footnotesize % Increased from \tiny to \footnotesize
    ...
    \begin{column}{0.51\textwidth}
      ...
      \centering
      \includegraphics[width=0.85\textwidth]{ecg_printing.png}
