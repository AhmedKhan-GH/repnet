  ...
  \begin{columns}[c]
    ...
    \begin{column}{0.60\textwidth}
      ...
      \begin{itemize}
        ...
        \item Each of the \textbf{12 leads} processed independently through a \textbf{shared-weight} 3-stage CNN

        \item Channel-independent activations \textbf{pooled} and \textbf{concatenated} into a single 576-dim activation map

        \item Single \textbf{fully connected layer} reduces the fused representation down to \textbf{class logits} (PE / Normal)

        \item Selected from \textbf{250 autonomous experiments} --- simpler architectures consistently outperformed complex ones
...
\begin{frame}{Neural Network Modeling --- Preprocessing \& Training}
  ...
  \resizebox{0.7\textwidth}{!}{%
    \begin{tabular}{lll}
      \toprule
      \textbf{Transform} & \textbf{Prob.} & \textbf{Range} \\
      \midrule
...
\begin{frame}{Neural Network Modeling --- Autonomous Architecture Search}
  ...
  {\small\Raleway\bfseries\color{aggieblue} 250 LLM-Driven Experiments (Karpathy's autoresearch)}\par\vspace{0.2em}
  \begin{beamercolorbox}[wd=0.95\textwidth,rounded=true,shadow=false,sep=0.2em]{boxgray}
    \centering
    \includegraphics[width=0.98\textwidth,height=3.2cm,keepaspectratio]{round_evolution.png}
  \end{beamercolorbox}
  ...
  \begin{columns}[c]
    \begin{column}{0.48\textwidth}
      ...
      \begin{beamercolorbox}[wd=\textwidth,rounded=true,shadow=false,sep=0.1em]{boxgray}
        \includegraphics[width=0.96\textwidth,height=2.4cm,keepaspectratio]{arch_family_comparison.png}
      \end{beamercolorbox}
    \end{column}
    \begin{column}{0.48\textwidth}
      \centering
      \begin{beamercolorbox}[wd=\textwidth,rounded=true,shadow=false,sep=0.1em]{boxgray}
        \includegraphics[width=0.96\textwidth,height=2.4cm,keepaspectratio]{auroc_vs_params.png}
      \end{beamercolorbox}
    \end{column}
  \end{columns}
\end{frame}
