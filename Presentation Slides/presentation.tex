  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.52\textwidth}
      ...
      \begin{itemize}
        ...
        \item Only definitive treatment is delivery
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.58\textwidth}
      ...
      \begin{minipage}[c]{0.40\textwidth}
        \centering
        \includegraphics[width=\textwidth,height=3.2cm,keepaspectratio]{biocare_ecg.jpg}
      \end{minipage}
      \hfill
      \begin{minipage}[c]{0.12\textwidth}
        \centering
        \tikz{
          \draw[-{Stealth[length=3mm]},line width=1.5pt,color=aggieblue] (0,0) -- (1.2,0);
          \node[color=red,font=\Large\bfseries\sffamily] at (0.6,0) {X};
        }
      \end{minipage}
      \hfill
      \begin{minipage}[c]{0.40\textwidth}
        \centering
        \includegraphics[width=\textwidth,height=3.2cm,keepaspectratio]{978-3-319-95114-0_53_Fig1_HTML.jpg}
      \end{minipage}

      \vspace{0.5em}
      \begin{beamercolorbox}[wd=\textwidth,rounded=true,shadow=false,sep=0.3em]{boxgray}
        \small\Lato\color{coolgray}\centering
        Our goal: detect diseases earlier with widely available ECG instead of dealing with complications and life support
      \end{beamercolorbox}
    \end{column}
