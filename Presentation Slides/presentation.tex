...
\begin{frame}{Preeclampsia Introduction}
  \begin{columns}[T]
    ...
    \begin{column}{0.52\textwidth}
      ...
      % Main Bullets
      \begin{itemize}
        \item Can progress to eclampsia (seizures) quickly
        \item A leading cause of maternal / infant mortality
        \item Delivery is the only definitive treatment, prevention is key
      \end{itemize}
    ...
    \begin{column}{0.44\textwidth}
      ...
      \begin{center}
        \includegraphics[width=0.50\textwidth]{Screenshot_521.png}
      \end{center}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.58\textwidth}
      ...
      \begin{minipage}[c]{0.60\textwidth}
        ...
        ECG diagnosis should be as easy and available as a thermometer
      \end{minipage}
      \hfill
      ...
      \begin{block}{}
        \label{fig:ecg_print}
        \includegraphics[width=0.95\textwidth,clip,trim=0 2.0cm 0 0]{ecg_printing.png}
      \end{block}
