...
\begin{frame}{Neural Network Modeling --- PerLeadCNN Architecture}
  \begin{columns}[T]
    ...
    \begin{column}{0.61\textwidth}
      \centering
      {\small\Raleway\bfseries\color{aggieblue} 30-Split AUROC Distribution}\\[0.2em]
      \begin{beamercolorbox}[wd=\textwidth,rounded=true,shadow=false,sep=0.1em]{boxgray}
        \centering
        \includegraphics[width=0.96\textwidth,height=3.4cm,keepaspectratio]{perlead_30split_distribution.png}
      \end{beamercolorbox}
