...
\begin{frame}{Preeclampsia Introduction}
  \begin{columns}[T]
    ...
    \begin{column}{0.52\textwidth}
      ...
      % Main Bullets
      \begin{itemize}
        \item Hypertensive disorder of pregnancy
        \item Definitive treatment is delivery
        \item Can progress to eclampsia (seizures) at a quick rate
      \end{itemize}
      ...
      \begin{beamercolorbox}[wd=\textwidth,rounded=true,leftskip=0.7em,rightskip=0.7em,sep=0.6em]{boxblue}
        ...
        We aim to predict the risk of Preeclampsia using Decision Tree Modeling and Neural Network Modeling
      \end{beamercolorbox}
      ...
      \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{depositphotos_ecg.png}
      \end{minipage}
    \end{column}
    ...
    \begin{column}{0.44\textwidth}
      ...
      \begin{center}
        \includegraphics[width=0.30\textwidth]{Photo-7-Female-Frontal.jpg}
      \end{center}
...
% ---------- Subsection Slide: 30-Split Validation ----------
\begin{frame}{Neural Network Modeling --- 30-Split Validation}
  \centering

  \begin{beamercolorbox}[wd=0.95\textwidth,rounded=true,shadow=false,sep=0.2em]{boxgray}
    \centering
    \includegraphics[width=0.98\textwidth,height=5.0cm,keepaspectratio]{perlead_30split_distribution.png}
  \end{beamercolorbox}
  ...
  \begin{columns}[T, onlytextwidth]
    \begin{column}{0.32\textwidth}
      \begin{beamercolorbox}[wd=\textwidth,rounded=true,shadow=false,sep=0.4em]{boxgray}
        \usebeamerfont{footline}\color{coolgray}
        \centering{\textbf{\color{aggieblue}Per-Lead Shared}}\par
        \vspace{0.3em}
        \scriptsize Same CNN for all 12 leads --- implicit regularizer
      \end{beamercolorbox}
    \end{column}
    \begin{column}{0.32\textwidth}
      \begin{beamercolorbox}[wd=\textwidth,rounded=true,shadow=false,sep=0.4em]{boxgray}
        \usebeamerfont{footline}\color{coolgray}
        \centering{\textbf{\color{aggieblue}Large$\to$Small $k$}}\par
        \vspace{0.3em}
        \scriptsize $31 \to 21 \to 11$: broad morphology first, then fine detail
      \end{beamercolorbox}
    \end{column}
    \begin{column}{0.32\textwidth}
      \begin{beamercolorbox}[wd=\textwidth,rounded=true,shadow=false,sep=0.4em]{boxgray}
        \usebeamerfont{footline}\color{coolgray}
        \centering{\textbf{\color{aggieblue}No Extras}}\par
        \vspace{0.3em}
        \scriptsize SE, attention, skip connections all failed to help
      \end{beamercolorbox}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Neural Network Modeling --- Model Performance (30-Split)}
  ...
  \begin{columns}[c]
    \begin{column}{0.55\textwidth}
      ...
      \begin{beamercolorbox}[wd=\textwidth,rounded=true,shadow=false,sep=0.1em]{boxgray}
        \includegraphics[width=0.98\textwidth,height=3.6cm,keepaspectratio]{roc_pr_curves.png}
      \end{beamercolorbox}
    \end{column}
    \begin{column}{0.42\textwidth}
      \centering
      \begin{beamercolorbox}[wd=\textwidth,rounded=true,shadow=false,sep=0.1em]{boxgray}
        \includegraphics[width=0.98\textwidth,height=3.6cm,keepaspectratio]{prediction_distribution.png}
      \end{beamercolorbox}
    \end{column}
  \end{columns}
  ...
  \resizebox{0.85\textwidth}{!}{%
    \begin{tabular}{lcccccc}
      ...
      \midrule
      Threshold-free         & $0.709 \pm 0.049$ & $0.342 \pm 0.075$ & --- & --- & --- & --- \\
      Screening (Sens $\geq 0.80$)  & --- & --- & $80.7 \pm 0.5\%$ & $49.6 \pm 8.9\%$ & $92.7 \pm 1.9\%$ & $0.367 \pm 0.061$ \\
      Youden's J             & --- & --- & $73.0 \pm 9.2\%$ & $62.7 \pm 12.6\%$ & $92.4 \pm 2.3\%$ & $0.404 \pm 0.069$ \\
      \bottomrule
    \end{tabular}
  }%
  ...
  \begin{columns}[c]
    \begin{column}{0.48\textwidth}
      \centering
      \begin{beamercolorbox}[wd=\textwidth,rounded=true,shadow=false,sep=0.1em]{boxgray}
        \includegraphics[width=0.96\textwidth,height=2.0cm,keepaspectratio]{clinical_thresholds.png}
      \end{beamercolorbox}
    \end{column}
    \begin{column}{0.48\textwidth}
      \centering
      \begin{beamercolorbox}[wd=\textwidth,rounded=true,shadow=false,sep=0.1em]{boxgray}
        \includegraphics[width=0.96\textwidth,height=2.0cm,keepaspectratio]{perlead_architecture.png}
      \end{beamercolorbox}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Neural Network Modeling --- Best Split Performance}
  ...
  \resizebox{0.92\textwidth}{!}{%
    \begin{tabular}{lcccccc}
      ...
      \textbf{Best Model}  & $\mathbf{0.858}$ & $\mathbf{0.598}$ & $\mathbf{75.3\%}$ & $\mathbf{88.4\%}$ & $\mathbf{94.7\%}$ & $\mathbf{0.647}$ \\
      \bottomrule
    \end{tabular}
  }%
  ...
  \begin{columns}[T, onlytextwidth]
    \begin{column}{0.48\textwidth}
      \begin{beamercolorbox}[wd=\textwidth,rounded=true,shadow=false,sep=0.3em]{boxgray}
        \usebeamerfont{footline}\color{coolgray}
        \centering Best model achieves \textbf{0.858} AUROC and \textbf{0.598} AUPRC
      \end{beamercolorbox}
    \end{column}
    \hfill
    \begin{column}{0.48\textwidth}
      \begin{beamercolorbox}[wd=\textwidth,rounded=true,shadow=false,sep=0.3em]{boxgray}
        \usebeamerfont{footline}\color{coolgray}
        \centering High specificity (\textbf{88.4\%}) at Youden's J with \textbf{94.7\%} NPV
      \end{beamercolorbox}
    \end{column}
  \end{columns}
\end{frame}

% ---------- Subsection Slide: Clinical Utility ----------
\begin{frame}{Neural Network Modeling --- Clinical Utility}
  \begin{columns}[c]

    \begin{column}{0.55\textwidth}
      \centering
      {\small\Raleway\bfseries\color{aggieblue} Confusion Matrix (Best Split)}\\[0.2em]
      \begin{beamercolorbox}[wd=\textwidth,rounded=true,shadow=false,sep=0.1em]{boxgray}
        \centering
        \includegraphics[width=0.98\textwidth,height=5.0cm,keepaspectratio]{confusion_matrix.png}
      \end{beamercolorbox}
    \end{column}

    \begin{column}{0.42\textwidth}
      \centering
      {\small\Raleway\bfseries\color{aggieblue} Decision Curve Analysis}\\[0.2em]
      \begin{beamercolorbox}[wd=\textwidth,rounded=true,shadow=false,sep=0.1em]{boxgray}
        \centering
        \includegraphics[width=0.98\textwidth,height=5.0cm,keepaspectratio]{decision_curve.png}
      \end{beamercolorbox}
    \end{column}
  ...
  \begin{columns}[T, onlytextwidth]
    \begin{column}{0.48\textwidth}
      \begin{beamercolorbox}[wd=\textwidth,rounded=true,shadow=false,sep=0.3em]{boxgray}
        \usebeamerfont{footline}\color{coolgray}
        \centering \textbf{86\%} of PE+ patients correctly identified; only 8 missed
      \end{beamercolorbox}
    \end{column}
    \hfill
    \begin{column}{0.48\textwidth}
      \begin{beamercolorbox}[wd=\textwidth,rounded=true,shadow=false,sep=0.3em]{boxgray}
        \usebeamerfont{footline}\color{coolgray}
        \centering Net benefit exceeds treat-all and treat-none across clinically relevant thresholds
      \end{beamercolorbox}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Neural Network Modeling --- Interpretability}
  \begin{columns}[c]
    ...
    \begin{column}{0.58\textwidth}
      \centering
      {\small\Raleway\bfseries\color{aggieblue} Grad-CAM Saliency (PE+ vs Normal)}\\[0.2em]
      \begin{beamercolorbox}[wd=\textwidth,rounded=true,shadow=false,sep=0.1em]{boxgray}
        \centering
        \includegraphics[width=0.98\textwidth,height=5.0cm,keepaspectratio]{gradcam_aggregate.png}
      \end{beamercolorbox}
    \end{column}

    \begin{column}{0.38\textwidth}
      \centering
      {\small\Raleway\bfseries\color{aggieblue} FC Weight Magnitude per Lead}\\[0.2em]
      \begin{beamercolorbox}[wd=\textwidth,rounded=true,shadow=false,sep=0.1em]{boxgray}
        \centering
        \includegraphics[width=0.98\textwidth,height=5.0cm,keepaspectratio]{lead_importance.png}
      \end{beamercolorbox}
    \end{column}
  ...
  \begin{columns}[T, onlytextwidth]
    \begin{column}{0.48\textwidth}
      \begin{beamercolorbox}[wd=\textwidth,rounded=true,shadow=false,sep=0.3em]{boxgray}
        \usebeamerfont{footline}\color{coolgray}
        \centering Saliency peaks in \textbf{P-wave} and \textbf{QT-interval} regions
      \end{beamercolorbox}
    \end{column}
    \hfill
    \begin{column}{0.48\textwidth}
      \begin{beamercolorbox}[wd=\textwidth,rounded=true,shadow=false,sep=0.3em]{boxgray}
        \usebeamerfont{footline}\color{coolgray}
        \centering \textbf{Lead aVL} highest differential saliency --- consistent with LV strain in PE
      \end{beamercolorbox}
    \end{column}
  \end{columns}
\end{frame}
