...
Outputs (optuna_results/optuna_crosslead_3stage_filters/YYYY-MM-DD_HH-MM-SS/):
...
def main():
    ...
    run_dir = Path("optuna_results/optuna_crosslead_3stage_filters") / datetime.now().strftime("%Y-%m-%d_%H-%M-%S")
